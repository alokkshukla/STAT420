...
To populate the `study_1` data of predixtors.
...
simulation1 = function(sigma){
  ...
  s_e[i] = sqrt(sum((study_1$y - y_hat) ^ 2) / (n - p))
...
In this Simulation Study we will how effective is using RMSE as a parameter for selecting the best model. We will be simulating following model
\begin{equation}
